    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(choices=[('Primavera', 'Primavera'), ('Otoño', 'Otoño')], default='Primavera', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.ManyToManyField(help_text='Seleccione un equipo para el estudiante', to='courses.Team')),
            ],
            options={
